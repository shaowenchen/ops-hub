...
curl -sfL "$PROXY"https://raw.githubusercontent.com/shaowenchen/ops-hub/master/os/get.sh | sh -
```
...
```bash
PROXY="https://ghproxy.chenshaowen.com/"
curl -sfL "$PROXY"https://raw.githubusercontent.com/shaowenchen/ops-hub/master/os/centos/get.sh | VERSION=7 sh -
```
...
```bash
PROXY="https://ghproxy.chenshaowen.com/"
curl -sfL "$PROXY"https://raw.githubusercontent.com/shaowenchen/ops-hub/master/os/debian/get.sh | VERSION=8 sh -
```
...
```bash
PROXY="https://ghproxy.chenshaowen.com/"
curl -sfL "$PROXY"https://raw.githubusercontent.com/shaowenchen/ops-hub/master/os/ubuntu/get.sh | VERSION=22.04 sh -
```
