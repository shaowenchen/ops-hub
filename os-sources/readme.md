...
curl -sfL "$PROXY"https://raw.githubusercontent.com/shaowenchen/ops-hub/master/os-sources/get.sh | sh -
```
...
```bash
PROXY="https://ghproxy.chenshaowen.com/"
curl -sfL "$PROXY"https://raw.githubusercontent.com/shaowenchen/ops-hub/master/os-sources/centos/get.sh | VERSION=7 sh -
```
...
```bash
PROXY="https://ghproxy.chenshaowen.com/"
curl -sfL "$PROXY"https://raw.githubusercontent.com/shaowenchen/ops-hub/master/os-sources/debian/get.sh | VERSION=8 sh -
```
...
```bash
PROXY="https://ghproxy.chenshaowen.com/"
curl -sfL "$PROXY"https://raw.githubusercontent.com/shaowenchen/ops-hub/master/os-sources/ubuntu/get.sh | VERSION=22.04 sh -
```
